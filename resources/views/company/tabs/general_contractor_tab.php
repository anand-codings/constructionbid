<div class="tab-pane <?= ($tab_id == '') ? 'active' : '' ?>" id="general_contractor" role="tabpanel">
    <div class='condructor-tabs'>
        <div class='condructor-tabs-header'>
            <div class='tabs-header'>
                ...
                <?php if ($result->getGeneralContractor) { ?>

                    <button class="btn btn_sm_white gc"  data-toggle="modal" data-target="#adddescription"> <i class="fa fa-plus" aria-hidden="true"></i> Edit Description</button>
                    <input type="hidden" name="gc_id" id="gc_id" value="<?= $result->getGeneralContractor->id ?>">
                    <input type="hidden" name="gc_id" id="gc_description" value="<?= $result->getGeneralContractor->description ?>">
                    <input type="hidden" name="gc_type" id="gc_type" value="gc">
                <?php } ?>
            </div> 
        ...
        <div class="condructor-tabs-body">
            <div class="contractor-description mb-40">
                ...
                <?php if ($result->getGeneralContractor) { ?>
                    <p><?= $result->getGeneralContractor->description; ?></p>
                <?php } else { ?>
                    <div class='add-description'>
                        <button class="btn btn_lg_tranparent gc " data-toggle="modal" data-target="#adddescription">Add Description</button>
            ...
            <?php if (isset($result->getGeneralContractor)) { ?>
                <div class="specialitys">
                    <div class="condructor-tabs-header">
                        <div class="tabs-header">
                            ...
                            <?php if (isset($result->getGeneralContractor->getSpecialities)) { ?>
                                <button class="btn btn_sm_white gc_special"  data-target="#other-services" data-toggle="modal"> <i class="fa fa-plus" aria-hidden="true"></i>Add/Edit Speciality</button>
                            <?php } ?>
                        </div> 
                    </div>
                    ...
                    <!-- Services -->
                    <?php if (isset($result->getGeneralContractor->getSpecialities)) { ?>
                        <div class="general_contractor_tags_special gc_contractor_tags_special">
                            <?php foreach ($result->getGeneralContractor->getSpecialities as $special) { ?>
                    ...
                    <?php } else { ?>
                        ...
                        <div class="specility-service">
                            <div class="form-group">
                                <label><a href=" #" class="gc_special" data-target="#other-services" data-toggle="modal">Add Speciality</a></label>
                            </div>
            ...
            <div class="condructor-tabs-header">
                <div class="tabs-header">
                    <h3>
                        Services in General Contractor
                    </h3>
                    <button class="btn btn_sm_white add_gc_service" data-toggle="modal" data-target="#addservices"> <i class="fa fa-plus" aria-hidden="true"></i> Create a Service</button>
                </div> 
            </div>
            <div class="contracts_sec">
                <?php foreach ($gc_services as $service) {
                    ?>
                            ...
                            <div class="condructor_tabing">
                                <div class="row">
                                    ...
                                    <div class="service-dropdown">
                                        <ul>
                                            <li>
                                                <a href="javascript:void();" data-toggle="modal" class='edit_gc' value='<?= $data->id; ?>' data-id='<?= $data->id ?>' data-target="#editservices"> <i class="fa fa-pencil" aria-hidden="true"></i> Edit Service</a>
                                            </li>
                                            <li>
...
<!--                    <h6><strong>What other deliverables do you need?</strong></h6>
                    ...
                    <div class="form-group">
                        <!--<input type="text" class="form-control gc-general-field-special" placeholder="Enter value">-->
                        <input type="hidden" name='specialities[]' id='specialities' placeholder="Enter value">
                        <input type="hidden" name='sp_id' id='gc_sp_id' placeholder="Enter value">
                        <input type="hidden" name='type'  value="gc">
                        <input type="hidden" name='_token' value='<?= csrf_token() ?>'>
                        <input type="hidden" name='specialities_id[]' id='specialities_id' placeholder="Enter value">
                    </div>

                    <!--                    <div class="form-group">
                                            <input type="button" class="btn btn_md_green px-4 gc-general-field" value="Add">
                                        </div>-->
                    <?php
                    if (isset($specialities)) {
                        ...
                        foreach ($specialities as $special) {
                            $count = 0;
                            if (isset($result->getGeneralContractor->getSpecialities) && $result->getGeneralContractor->getSpecialities->isNotEmpty() && isset($result->getGeneralContractor->getSpecialities)) {
                                foreach ($result->getGeneralContractor->getSpecialities as $company_special) {
...
?>
                    ...
                    <div class="form-group">
                        <input type="submit" class="btn btn_md_green px-4 add_speciality_forn" value="Save">
                    </div>
