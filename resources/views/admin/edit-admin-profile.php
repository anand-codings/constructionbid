                        ...
                        <form method="POST" enctype="multipart/form-data" action="<?= asset('save_edit_profile_data'); ?>" >
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="full_name" value="<?= $detail->full_name ?>" placeholder="Full Name">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="attachment">
                                            ...
                                            <label class="attachment-link" for="file-attach">
                                                ...
                                                <input type="file" name="profile_img" style="display:none;" id="file-attach"/>
                                            </label>
                                        </div>
                                    </div>
                                </div>
