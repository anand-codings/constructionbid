                                   ...
                                   <td align="center" valign="top" style="">
                                        <table border="0" cellpadding="20" cellspacing="0"  style="width:100%;padding-bottom:0px;">
                                             ...
                                             <?php if($status=='accept'){ ?>
                                              <tr>
                                                  <td style="padding: 0 0 20px 0;font-family: 'Lato', sans-serif;font-size: 20px;text-align:left;color:#000;font-weight: 800;">Subject : Your Proposal has been accepted .
                                                  </td>
                                             </tr>
                                             <?php } elseif($status=='reject'){ ?>
                                              <tr>
                                                  <td style="padding: 0 0 20px 0;font-family: 'Lato', sans-serif;font-size: 20px;text-align:left;color:#000;font-weight: 800;">Subject : Your Proposal has been rejected .
                                                  </td>
                                             </tr>
                                             <?php } ?>
                                             
                                              <tr>
                                                  <td style="padding: 0 0 20px 0;font-family: 'Lato', sans-serif;font-size: 20px;text-align:left;color:#000;font-weight: 800;">By : <?=$homeowner_first_name?>  <?=$homeowner_last_name?>.
                                                  </td>
                                             ...
                                             <tr>
                                                  <td style="padding: 20px 0 20px 0;text-align: center;">
                                                       <a href="<?=asset($link);?>" style="background-color: #1ec51e;color:#fff;text-decoration:none;padding:10px 50px;font-size: 13px;font-family: 'Lato', sans-serif;font-weight:400;width: 120px;display: inlinek;margin:0 auto;border-radius:5px;text-align: center;">View Job</a>
                                                       <!--<a href="#" style="background-color: red;text-decoration:none;text-decoration:none;color:#fff;padding:10px 50px;font-size: 13px;font-family: 'Lato', sans-serif;font-weight:400;width: 120px;display: inlinek;margin:0 auto;border-radius:5px;text-align: center;">Reject</a>-->
                                                  </td>
                                             </tr>
                                             <tr>
